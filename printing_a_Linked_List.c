// Printing a Linked List in the same order and in the reverse order
...
// This function prints the Linked List in the reverse order
void printList_reverse(struct Node *node)
{
     if(node==NULL)
     return;
...
void main()
{
  ...
  printf("\n Final Created Linked list printed in the reverse order is: \n");
